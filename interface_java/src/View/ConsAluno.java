...
public class ConsAluno extends javax.swing.JFrame {
   ...
   boolean flag=false;
        ...
        for(int x=0;x<=z;x++){
            ...
            for(int y=0;y<=12;y++){
               doc=Integer.toString(x+1);
                String conteudo = Arquivo.Read(doc+"aluno.txt");
    ...
    private void initComponents() {
        ...
        tabela.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nome", "Matricula", "CPF", "Curso", "Data Inicio", "Data fim", "Endereço", "Instituição", "Situação", "Codigo", "Telefone", "Email", "Tipo"
            }
        ) {
        ...
        Bsalvar.setText("Salvar modificações");
...
JOptionPane.showMessageDialog(null,"Dados modificados com sucesso!");
    ...
    private void excluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_excluirActionPerformed
      ...
      salvar b = new salvar();
      b.lerquantA();
     int z=b.quantidadeAluno-1;
     String frase,arquivo,arquivo1;
     for(int x=(linha);x<z;x++){
         
     arquivo=Integer.toString(x+2)+"aluno.txt";
     System.out.println("linha de baixo:"+arquivo);
     frase=Arquivo.Read(arquivo);
     arquivo1=Integer.toString(x+1)+"aluno.txt";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsAluno.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
