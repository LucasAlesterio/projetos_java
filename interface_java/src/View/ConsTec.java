...
public class ConsTec extends javax.swing.JFrame {
boolean flag=false;
        ...
        for(int x=0;x<=z;x++){
            ...
            for(int y=0;y<=7;y++){
               doc=Integer.toString(x+1);
                String conteudo = Arquivo.Read(doc+"tec.txt");
    ...
    private void initComponents() {
        ...
        tabela.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nome", "Piso", "Salario", "CPF", "CTPS", "Email", "Endereço", "Telefone"
            }
        ));
...
JOptionPane.showMessageDialog(null,"Dados modificados com sucesso!");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
      ...
      salvar b = new salvar();
      b.lerquantT();
     int z=b.quantidadetec-1;
     String frase,arquivo,arquivo1;
     for(int x=(linha);x<z;x++){
         
     arquivo=Integer.toString(x+2)+"tec.txt";
     frase=Arquivo.Read(arquivo);
     arquivo1=Integer.toString(x+1)+"tec.txt";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsTec.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
